...
INSERT INTO [ShowOrder] (ShowId, ShowDateTimeId, [Uid], OrderDate)
VALUES
((SELECT ShowId FROM SHOW WHERE [ShowName]='Who''s Afraid of Virginia Woolf'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200802 02:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='kelseycreel@gmail.com'), '20200604 07:34:48 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Sister Act'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200815 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='wittenberg.jacob@gmail.com'), '20200603 10:06:27 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Death of a Salesman'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200830 04:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='denviol125@gmail.com'), '20200603 11:26:12 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='The Curious Incident of the Dog in the Night-Time'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200809 05:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='evangdesigns@gmail.com'), '20200604 10:22:36 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='A Midsummer Night''s Dream'),(SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200801 08:00:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='kelseycreel@gmail.com'), '20200602 12:31:28 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Hamlet'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200821 08:00:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='wittenberg.jacob@gmail.com'), '20200601 10:06:27 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Hamlet'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200821 08:00:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='denviol125@gmail.com'), '20200605 08:45:12 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Chorus Line'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200807 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='evangdesigns@gmail.com'), '20200604 04:16:36 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Death of a Salesman'),(SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200905 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='kelseycreel@gmail.com'), '20200602 07:34:48 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Death of a Salesman'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200905 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='wittenberg.jacob@gmail.com'), '20200601 11:06:27 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Death of a Salesman'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200905 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='denviol125@gmail.com'), '20200605 11:26:12 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Sister Act'),(SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200821 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='kelseycreel@gmail.com'), '20200608 09:04:23 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Who''s Afraid of Virginia Woolf'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200816 07:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='wittenberg.jacob@gmail.com'), '20200610 06:06:07 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Hamlet'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200821 08:00:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='denviol125@gmail.com'), '20200615 07:26:12 AM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='Chorus Line'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200906 01:00:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='kelseycreel@gmail.com'), '20200604 03:21:46 PM'),
((SELECT ShowId FROM SHOW WHERE [ShowName]='The Curious Incident of the Dog in the Night-Time'), (SELECT [ShoeDateTimeId] FROM [ShowDateTime] WHERE [ShowDateTime]='20200809 05:30:00 PM'), (SELECT [Uid] FROM [User] WHERE [email]='wittenberg.jacob@gmail.com'), '20200608 05:12:36 PM')